<?php
	...
	if(isset($_REQUEST["submitted"])) {
		...
		$result = mysql_query("SELECT DISTINCT question_id FROM P4MobileMnewsQuestions WHERE TaskID = $taskid");
	...
	$result = mysql_query("SELECT * FROM P4MobileMnewsQuestions WHERE TaskID = $taskid ORDER BY question_order");
	if (!$result) {
			$message  = 'Invalid query: ' . mysql_error() . "\n";
			$message .= 'Whole query: ' . $query;
	}
			...
			<div class='instruction'>
				<?php
					...
					if ($taskid == 15) {
						...
						echo "Thank you very much for participanting our user study!";
						...
						echo "<a href='images/Tabbed.png' data-lightbox='image1' data-title='Tabbed'>";
						echo "<img src='images/Tabbed.png' width='100px'/></a></div>";
						
						echo "<div class='image'>";
						echo "<a href='images/CollapseAll.jpg' data-lightbox='image2' data-title='CollapseAll'>";
						echo "<img src='images/CollapseAll.jpg' width='100px'/></a></div><br><br><br><br></div>";

						echo "<div><label for='panel'>Tabbed&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>";
						echo "<label for='panel'>CollapseAll</label></div>";
