<?php
	...
	// 	die();
	// }
	$languageArray= array("en-US"=>"English Task Description", "zh-CN"=>"Simplified Chinese Task Description", "zh-HK"=>"Traditional Chinese Task Desrption",
												"fr-FR"=>"French Task Description", "de-DE"=>"German Task Description", "es-ES"=>"Spanish Task Description", "it-IT"=>"Italian Task Description");
	...
	if(isset($_REQUEST["taskid"])) {
		...
		$result = mysql_query("SELECT * FROM Searches WHERE TaskID = $taskid");
		...
		<div class='container'>
			<div class='headerContainer<?php echo $option_display?>'oncopy="return false" oncut="return false" onpaste="return false">
				...
				if($language1 != "" && !$_SESSION['injected'])
				{
					...
					$_SESSION['language1'] = "en-US";
					$_SESSION['injected'] = true;
					echo '<input type="radio" name="language" id="language1" value="en-US" class="css-radio" checked="">';
					echo '<label for="language1" class="css-radio-label">English</label>';
				}
				if($language2 != "" && !$_SESSION['injected'])
				{
					...
					$_SESSION['injected'] = true;
					echo '<input type="checkbox" name="language2" id="language2" value="zh-CN" class="css-checkbox" checked=""> <label for="language2" class="css-checkbox-label">中文</label>';
				} else if($_SESSION['interface'] == 'tabbed'){
					$_SESSION['language2'] = "zh-CN";
					$_SESSION['injected'] = true;
					echo '<input type="radio" name="language" id="language2" value="zh-CN" class="css-radio" checked="">';
					echo '<label for="language1" class="css-radio-label">中文</label>';
				}
				if($language3 != "")
				{
